          ...
          <View className="bg-white border border-[#e5e7eb] rounded-3xl p-6 shadow-sm">
            ...
            <View className="flex-row bg-[#f3f4f6] rounded-2xl p-1 mb-6">
              <TouchableOpacity
                ...
                className={`flex-1 py-2.5 items-center rounded-xl ${mode === "signin" ? "bg-white shadow-sm" : ""
                  }`}
              >
              ...
              <TouchableOpacity
                ...
                className={`flex-1 py-2.5 items-center rounded-xl ${mode === "signup" ? "bg-white shadow-sm" : ""
                  }`}
              >
